...
export const t = {
  ...
  landing: {
    signIn: "כניסה",
    kicker: "אימון אישי · תנועה · שיקום",
    title1: "תנועה.",
    title2: "כוח.",
    title3: "איזון.",
    subtitle:
      "סטודיו Omix - ליווי אישי שמתאים את האימון בדיוק אלייך. אימון, תנועה ושיקום שמכבדים את הקצב, היכולות והמטרות שלך.",
    ctaEnter: "כניסה למערכת",
    ctaContact: "צרו קשר",
    scrollHint: "גלול/י",

    aboutKicker: "הגישה שלנו",
    aboutTitle: "אימון שמתאים בדיוק לך",
    aboutBody:
      "כל גוף מספר סיפור אחר. ב-Omix בונים לך תוכנית אישית לגמרי - בלי השוואות ובלי לחץ - עם ידע, סבלנות והרבה תשומת לב, כדי שתחזרי לזוז בכוח, ביציבות ובהנאה.",

    servicesKicker: "מה אנחנו מציעים",
    servicesTitle: "השירותים שלנו",
    services: [
      { t: "אימון אישי", d: "אחד על אחד, תוכנית בהתאמה מלאה למטרות ולגוף שלך." },
      { t: "אימון קבוצתי", d: "אנרגיה של קבוצה קטנה, עם יחס אישי לכל אחת." },
      { t: "אימון אונליין", d: "מתאמנים בשידור חי מכל מקום, באותה איכות ליווי." },
      { t: "תנועה ושיקום", d: "חזרה לתנועה נכונה - בעדינות, בהדרגה ובבטחה." },
      { t: "טיפול בפציעות", d: "ליווי מקצועי בדרך החזרה מפציעה, צעד אחר צעד." },
    ] as { t: string; d: string }[],

    whyKicker: "למה Omix",
    whyTitle: "מה שמייחד אותנו",
    why: [
      { t: "ליווי אישי אמיתי", d: "מאמנת שמכירה אותך, את הגוף ואת המטרות שלך." },
      { t: "הזמנה בקליק", d: "רואים את הלוח ושומרים מקום לאימון בלחיצה אחת." },
      { t: "בקצב שלך", d: "תוכנית חיה שמתפתחת ומשתנה יחד איתך." },
    ] as { t: string; d: string }[],
